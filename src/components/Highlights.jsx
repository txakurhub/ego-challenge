...
const Highlights = ({ data, side = true }) => {
  return (
    <article
      className={`flex-col lg:w-8/12 lg:mt-20 flex lg:gap-32 px-2 ${
        side ? "lg:flex-row" : "lg:flex-row-reverse"
      }`}
    >
      <img src={data?.image} alt={data?.title} className="object-contain rounded-xl"/>
      <div className="flex flex-col lg:w-5/12 gap-5">
